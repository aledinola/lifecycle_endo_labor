...
The run writes the table `output.txt` and timing file `runtime_report.txt` in this folder. Plotting calls are currently commented out in `sol_prog10_07.f90` so the model does not require `gnuplot`.
